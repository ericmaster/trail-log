...
def upload_fit_file(
    ...
    # Generate unique filename. Use only the base name of the uploaded
    # filename so path traversal sequences (e.g. "../../etc/passwd") can't
    # escape the user's upload directory.
