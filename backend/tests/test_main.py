...
class TestFileUpload:
    ...
    def test_upload_sanitizes_path_traversal_filename(self, tmp_path, monkeypatch):
        ...
        # The traversal sequence must be stripped so the file stays inside the
        # sandboxed upload directory instead of escaping to "../../../etc".
        assert tmp_path.resolve() in saved_path.parents
